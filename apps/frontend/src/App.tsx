...
const STT_PRESETS: SttPreset[] = [
  ...
  },
  {
    ...
    tier: "paid",
    price: "$0.10/1M вх.",
    description: "Google Gemini 2.0 Flash через OpenRouter. Диаризация спикеров, полный анализ встречи одним запросом.",
    envVar: "OPENROUTER_API_KEY",
    diarization: true,
  },
  {
    name: "Gemini 3 Flash Preview via OpenRouter",
    provider: "openrouter-gemini3-flash",
    model: "google/gemini-3-flash-preview",
    tier: "paid",
    price: "$0.15/1M вх.",
    description: "Google Gemini 3 Flash Preview через OpenRouter. Новейшая модель — более высокое качество транскрипции.",
    envVar: "OPENROUTER_API_KEY",
    diarization: true,
  },
  {
