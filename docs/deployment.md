...
GLADIA_API_KEY=...
TELEGRAM_BOT_TOKEN=...
APP_URL=https://app.sense-ai.ru

# Email: отправка через SMTP (Beget или другой провайдер)
# Если нужен Resend API — раскомментируй RESEND_API_KEY и убери SMTP_* блок
# RESEND_API_KEY=re_...
SMTP_HOST=smtp.beget.com
SMTP_PORT=2525
SMTP_FROM=AI_Meet_Factory@sense-ai.ru
SMTP_USER=AI_Meet_Factory@sense-ai.ru
SMTP_PASS=замени_на_пароль_почты
EOF
```
